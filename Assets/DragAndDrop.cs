...
public class DragAndDrop : MonoBehaviour
{
    ...
    private float min_X = -2.34f;

    private float max_X = 2.34f;
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            GameManager.Instance.levels[GameManager.Instance.GetCurrentIndex()].items.Remove(this);
            GameManager.Instance.levels[GameManager.Instance.GetCurrentIndex()].items.Remove(collision.gameObject.GetComponent<DragAndDrop>());
            Destroy(gameObject);
